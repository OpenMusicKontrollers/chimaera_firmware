...
_dma_write_append (uint8_t *buf, uint8_t cntrl, uint16_t addr, uint8_t *dat, uint16_t len)
{
	*buf++ = addr >> 8;
	*buf++ = addr & 0xFF;
	*buf++ = cntrl | W5500_CNTRL_PHASE_WRITE;
...
__always_inline uint8_t *
_dma_write_inline (uint8_t *buf, uint8_t cntrl, uint16_t addr, uint16_t len)
{
	*buf++ = addr >> 8;
	*buf++ = addr & 0xFF;
	*buf++ = cntrl | W5500_CNTRL_PHASE_WRITE;
...
__always_inline uint8_t *
_dma_read_append (uint8_t *buf, uint8_t cntrl, uint16_t addr, uint16_t len)
{
	*buf++ = addr >> 8;
	*buf++ = addr & 0xFF;
	*buf++ = cntrl | W5500_CNTRL_PHASE_READ;
